...
class LaporanMasuk extends Controller
{
    public function lmasuk_op_burner()
    {
        ...
        compact('data','mon', 'totburner','totsbl','totedg','user','nb','nedg','nct','ncb','ncc','nfw','nhp','nhsd','nsbl'));
    }
    ...
    public function lmasuk_op_edg()
    {
        ...
        return view('pages.supervisor.lmasuk_op.edg.lmasuk_edg', compact('data','mon', 'totburner','totsbl','totedg','user','nb','nedg','nct','ncb','ncc','nfw','nhp','nhsd','nsbl'));
    }
