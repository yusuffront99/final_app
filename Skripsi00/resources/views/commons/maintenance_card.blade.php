<div class="row">
    <div class="col-lg-4 mb-3">
        <div class="card border border-danger shadow-md">
            ...
            @if ($data_burner > 0)
            <a href="{{route('maintenance-burner.index')}}" class="new-notif text-white" data-bs-toggle="tooltip" data-bs-placement="top" title="ada {{$data_burner}} Laporan Baru"><i class='bx bx-bell' ></i></a href="">
            @endif
