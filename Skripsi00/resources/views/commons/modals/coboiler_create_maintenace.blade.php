...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="m-2">
            <form action="" id="form-maintenance-coboiler">
  ...
  $(document).ready(function(){
    $.ajaxSetup({
        ...
        $('#create-detail').click(function(){
            $('#form-maintenance-coboiler').trigger("reset");
        })
        ...
        $('#save').click(function (e) {
            ...
            $.ajax({
                url: "{{route('maintenance-coboiler.store')}}",
                method: 'POST',
                data: $('#form-maintenance-coboiler').serialize(),
                dataType: 'JSON',
        ...
        $('body').on('click', '#create_detail', function () {
          var id = $(this).data('id');
          $.get('coboiler/'+id+'/edit', function(data) {
