...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="m-2">
            <form action="" id="form-maintenance-coturbine">
  ...
  $(document).ready(function(){
    $.ajaxSetup({
        ...
        $('#create-detail').click(function(){
            $('#form-maintenance-coturbine').trigger("reset");
        })
        ...
        $('#save').click(function (e) {
            ...
            $.ajax({
                url: "{{route('maintenance-coturbine.store')}}",
                method: 'POST',
                data: $('#form-maintenance-coturbine').serialize(),
                dataType: 'JSON',
        ...
        $('body').on('click', '#create_detail', function () {
          var id = $(this).data('id');
          $.get('coturbine/'+id+'/edit', function(data) {
