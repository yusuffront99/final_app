...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="m-2">
            <form action="" id="form-maintenance-fwpump">
  ...
  $(document).ready(function(){
    $.ajaxSetup({
        ...
        $('#create-detail').click(function(){
            $('#form-maintenance-fwpump').trigger("reset");
        })
        ...
        $('#save').click(function (e) {
            ...
            $.ajax({
                url: "{{route('maintenance-fwpump.store')}}",
                method: 'POST',
                data: $('#form-maintenance-fwpump').serialize(),
                dataType: 'JSON',
        ...
        $('body').on('click', '#create_detail', function () {
          var id = $(this).data('id');
          $.get('fwpump/'+id+'/edit', function(data) {
