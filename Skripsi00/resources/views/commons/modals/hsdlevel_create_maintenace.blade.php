  ...
  $(document).ready(function(){
    $.ajaxSetup({
        ...
        $('#create-detail').click(function(){
            $('#form-maintenance-hsdlevel').trigger("reset");
        })
        ...
        $('#save').click(function (e) {
            ...
            $.ajax({
                url: "{{route('maintenance-hsdlevel.store')}}",
                method: 'POST',
                data: $('#form-maintenance-hsdlevel').serialize(),
                dataType: 'JSON',
        ...
        $('body').on('click', '#create_detail', function () {
          var id = $(this).data('id');
          $.get('hsdlevel/'+id+'/edit', function(data) {
