...
<div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
  ...
  <ul class="navbar-nav flex-row align-items-center ms-auto">
    ...
    {{-- <li class="nav-item lh-1 me-3">
      <a href="">
        <span class="badge bg-danger belt rounded-pill bell-notif">2</span>
        <i class='bx bx-bell fs-3 text-danger'></i>
      </a>
    </li> --}}
    ...
    <li class="nav-item navbar-dropdown dropdown-user dropdown">
      ...
      <ul class="dropdown-menu dropdown-menu-end">
        ...
        <li>
          <div class="dropdown-item" id="nav-bar-logoutbutton">                       
            <a class="dropdown-item btn btn-sm btn-danger text-center" href="{{ route('logout') }}"
