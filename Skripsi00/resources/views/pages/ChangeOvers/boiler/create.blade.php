        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="mx-auto">
                <div class="m-auto rounded text-dark">
                    <form action="" class="mx-auto" id="form-co-boiler">
                        @csrf
                        <div class="row shadow-sm p-3 bg-light rounded">
                            ...
                            <div class="col-lg-6 col-md-6 fw-bold">
                                <div class="form-group mb-2 mx-3">
                                    ...
                                    <input type="text" name="nama_peralatan" id="nama_peralatan" class="form-control" placeholder="Seal Air Fan" required>
                                </div>
                                <div class="form-group mb-2 mx-3">
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#btn-save').click((e)=>{
                ...
                $.ajax({
                    url: "{{route('coboiler.store')}}",
                    method: 'POST',
                    data: $('#form-co-boiler').serialize(),
                    dataType: 'JSON',
                    success: function(data){
                        if(data.success){
                            ...
                            $("span").remove('#error')
                            window.location = "{{route('coboiler.index')}}"
                        }else{
                            console.log('gagal');
                        }
                    },
