            ...
            <div class="card p-3">
                <div class="p-2">
                    <div class="d-flex justify-content-between">
                        <a href="{{route('coboiler.create')}}" class="btn btn-sm btn-success" width="25%"><i class='bx bxs-plus-circle'></i> create CO Boiler</a>
                ...
                <div class="row">
                        ...
                        <div class="row py-3 rounded m-auto">
                            <div class="col-lg-12 col-md-12 col-sm">
                                <div class="mb-2">
                                    <small class="text-dark fst-italic"><i class='bx bx-info-circle'></i> Laporan Change Over Peralatan Boiler adalah sebuah laporan yang dibuat untuk mengupdate kondisi terakhir peralatan tersebut. Yang mana ini dilakukan setiap seminggu sekali (Hari Selasa)</small><br>
                                    <a href="{{route('all_view_coboiler')}}" class="btn btn-warning btn-sm rounded-pill btn-all-info">All Information <i class='bx bxs-right-arrow-circle'></i></a>
                                </div>
                                                    ...
                                                    <td>
                                                        ...
                                                        @if ($dt->status_equipments->status_name == 'Rejected')
                                                            <div class="text-center">
                                                                <a href="{{route('coboiler.edit', $dt->id)}}"><i class='bx bx-edit fs-4 text-danger'></i></a>
                                                            </div>
                                                        @endif
...
<div class="modal-dialog">
    ...
    <div class="modal-header">
        <h1 class="modal-title fs-5 fw-bold" id="exampleModalLabel"><i class='bx bx-info-circle'></i> Laporan Change Over Peralatan Boiler</h1>
