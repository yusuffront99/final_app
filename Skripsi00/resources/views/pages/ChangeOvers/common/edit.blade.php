        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="mx-auto">
                <div class="m-auto rounded text-dark">
                    <form action="{{route('cocommon.update', $data_id->id)}}" method="POST" class="mx-auto" id="form-co-turbine">
                        @csrf
                        @method('put')
                        <div class="row shadow-sm p-3 bg-light rounded">
                            ...
                            <div class="col-lg-6 col-md-6 text-dark fw-bold">
                                ...
                                <div class="form-group mb-2 mx-3">
                                    ...
                                    <input type="text" name="unit" id="unit" value="{{$data_id->nama_peralatan}}" class="form-control">
                                </div>
                                <div class="form-group mb-2 mx-3">
