        ...
        <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="row">
                    <div class="col-lg-8 col-sm-9">
                        <div class="p-2">
                            ...
                            /
                            <a href="{{route('coturbine.index')}}" class="text-primary mx-2">
                                CO Turbine
                            </a>
                            /
            ...
            <div class="mx-auto">
                <div class="m-auto rounded text-dark">
                    <form action="{{route('coturbine.update', $data_id->id)}}" method="POST" class="mx-auto" id="form-co-turbine">
                        @csrf
                        @method('put')
                        <div class="row shadow-sm p-3 bg-light rounded">
                            <div class="mb-2">
                                <a href="{{route('coturbine.index')}}" class="btn btn-sm btn-primary rounded-pill"><i class='bx bx-left-arrow-circle'></i> Back</a>
                            </div>
                            <h6 class="text-white bg-dark p-3 text-center rounded-pill">Form Change Over Peralatan Turbine</h6>
                            <hr>
