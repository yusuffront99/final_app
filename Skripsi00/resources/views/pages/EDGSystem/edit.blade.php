        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="mx-auto">
                <div class="m-auto rounded text-dark">
                    <form action="{{route('edg_system.update', $data_id->id)}}" method="POST" class="mx-auto" id="form-burner-system">
                        @csrf
                        @method('put')
                        ...
                        <div class="row shadow-sm p-3 bg-light rounded">
                            ...
                            <label for="">Keterangan</label>
                                <input type="text" name="keterangan" id="keterangan" class="form-control" value="{{$data_id->keterangan}}" required>
                            </div>
                            <div class="d-grid gap-2 px-4 py-2 mx-1">
