        ...
        <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="col-lg-8 col-sm-9">
                        <div class="p-2">
                            ...
                            <span class="text-primary mx-2">
                                Data LFO System / High Pressure Pump
                            </span>
                            /
            ...
            <div class="mx-auto">
                <div class="m-auto rounded text-dark">
                    <form action="{{route('admin.update.hppump', $data_id->id)}}" method="POST" class="mx-auto" id="form-lfo-system">
                        @csrf
                        @method('put')
                                ...
                                <div class="col-lg-6 fw-bold form-fw">
                                    ...
                                    <div class="form-group mb-2 mx-3">
                                        ...
                                        <div class="row m-auto my-1">
                                            <div class="col">
                                                <h6 class="text-center">A</h6>
                                                <input type="text" value="{{$data_id->arus_HP_A}}" name="arus_HP_A" id="arus_HP_A" class="form-control">
                                            </div>
                                            <div class="col">
                                                <h6 class="text-center">B</h6>
                                    ...
                                    <div class="form-group mb-2 mx-3">
                                        <label for="press_HP">Pressure HP Pump (A)</label>
                                        <div class="row m-auto my-1">
                                            <div class="col">
                                                <h6 class="text-center">A</h6>
