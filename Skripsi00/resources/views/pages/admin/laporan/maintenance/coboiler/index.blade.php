                ...
                <div class="card shadow-sm p-3 bg-light">
                    <div class="row">
                        <div class="d-flex justify-content-between mb-1">
                            ...
                            <a href="{{route('history.coboiler')}}" class="btn btn-sm btn-success px-4 rounded-pill">See More <i class='bx bx-grid-small'></i></a>
                        </div>          
                        <br>
                        ...
                        <div class="m-auto">
                        <span class="badge bg-primary p-3 fw-bold rounded mb-4" style="width: 100%">EQUIPMENT REPAIR DATA - CHANGE OVER PERALATAN BOILER</span>
                        </div>
