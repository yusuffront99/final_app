                ...
                <div class="card shadow-sm p-3 bg-light">
                    <div class="row">
                        <div class="d-flex justify-content-between mb-1">
                            ...
                            <a href="{{route('history.edg')}}" class="btn btn-sm btn-success px-4 rounded-pill">See More <i class='bx bx-grid-small'></i></a>
                        </div> 
                        <br>
...
@include('commons.modals.edg_create_maintenace')
