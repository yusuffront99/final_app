                ...
                <div class="card shadow-sm p-3 bg-light">
                    <div class="row">
                       ...
                       <br>
                        ...
                        <div class="m-auto">
                        <span class="badge bg-primary p-3 fw-bold rounded mb-4" style="width: 100%">EQUIPMENT REPAIR DATA - HIGH PRESSURE PUMP</span>
                        </div>
                        ...
                        <thead class="table-primary">
                            <tr>
                                ...
                                <th class="common-info text-center">Status</th>
                            </tr>
                        </thead>
                        <tbody>
