                ...
                <div class="row">
                    <div class="col-lg-8 col-sm-9">
                        <div class="p-2">
                            ...
                            /
                            <a href="{{route('hp_pump.index')}}" class="text-primary">
                                LFO System
                            </a>
                            /
            ...
            <div class="my-3">
                <div class="card shadow-sm p-3 bg-light">
                    <table id="example" class="table table-striped my-3" style="width:100%">
                        <div>
                            <a href="{{route('hp_pump.index')}}" class="btn btn-sm btn-dark"><i class='bx bx-left-arrow-circle'></i> Back</a>
                        </div>

                        <span class="badge bg-primary p-3 fw-bold rounded my-3" style="width: 100%">DATA LFO SYSTEM - HIGH PRESSURE PUMP</span>
