                            ...
                            <div class="row py-3 rounded m-auto">
                                <div class="col-lg-12 col-md-12">
                                    <div class="card bg-secondary text-white p-3">
                                                    ...
                                                    <tr>
                                                        <td class="text-center">
                                                            @if ($dt->status_equipments->status_name == 'Forward')
                                                                <a href="{{route('har.burner_validation', $dt->id)}}" class="text-primary"><i class="bx bx-edit fs-3"></i></a>
                                                        ...
                                                        <td>
                                                            <small class="bg-primary rounded-pill px-2 py-1">{{Carbon\carbon::createFromFormat('Y-m-d', $dt->tanggal_update)->format('d-m-Y')}}</small>
                                                            <small class="bg-success rounded-pill px-2 py-1">{{$dt->operator_shift}}</small>
                                                            
                                                            <div class="mt-4">
                                                                <div class="row">
                                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                                        <div class="px-2">
                                                                            <strong class="text-primary">Burner 1</strong>
                                                                    ...
                                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                                        <div class="px-2">
                                                                            <strong class="text-primary">Burner 2</strong>
                                                                    ...
                                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                                        <div class="px-2">
                                                                            <strong class="text-primary">Burner 3</strong>
                                                                    ...
                                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                                        <div class="px-2">
                                                                            <strong class="text-primary">Burner 4</strong>
                                        ...
                                        <a href="{{route('har.all_burner_validation')}}" class="btn btn-primary text-white btn-sm rounded-pill btn-view mt-3">see all <i class='bx bxs-right-arrow-circle'></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
