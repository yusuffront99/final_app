                ...
                <div class="row">
                    <div class="col-lg-8 col-sm-9">
                        <div class="p-2">
                            ...
                            /
                            <a href="{{route('lmasuk.har.coboiler')}}" class="text-primary">
                                CO Boiler
                            </a>
                            /
                ...
                <div class="card shadow-sm p-3 bg-light">
                    <table id="example" class="table table-striped my-3" style="width:100%">
                        <div class="d-flex justify-content-between mb-3">
                            <div>
                                <a href="{{route('lmasuk.har.coboiler')}}" class="btn btn-sm btn-dark"><i class='bx bx-left-arrow-circle'></i> Back</a>
                            </div>
                        </div>
                        <span class="badge bg-primary p-3 fw-bold rounded mb-4" style="width: 100%">CHANGE OVER PERALATAN BOILER VALIDATIONS - {{Auth::user()->tim_divisi}}</span>
                        ...
                        <tbody>
                            ...
                            @foreach ($data as $dt)
                                <tr>
                                    <td>{{$no++;}}</td>
                                    <td>
                                        <a href="{{route('har.coboiler_validation', $dt->id)}}" class="bg-danger p-2 text-white"><i class='bx bx-edit'></i></a>
                                    </td>
                                    <td>{{$dt->users->nip}}</td>
