        ...
        <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="row">
                    <div class="col-lg-8 col-sm-9">
                        <div class="p-2">
                            ...
                            /
                            <a href="{{route('lmasuk.har.coboiler')}}" class="text-primary mx-2">
            ...
            <div class="row">
                <div class="d-flex justify-content-between mb-3">
                    <div>
                        <a href="{{route('lmasuk.har.coboiler')}}" class="btn btn-sm btn-primary"><i class='bx bx-left-arrow-circle'></i> Back</a>
                    </div>
                </div>
            </div>
            <div class="mx-auto">
                <div class="m-auto rounded">
                    <form action="{{route('har.coboiler_updated', $data_id->id)}}" method="POST" class="mx-auto" id="edit-edg-system">
                            @csrf
                            @method('put')
                            ...
                            <div class="p-3 card bg-secondary text-white">
                                <h5 class="text-primary fw-bold">Validation CO Boiler</h5>
                                <br>
