    ...
    <div class="content-wrapper mt-2">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="d-flex justify-content-between">
                <div>
                    <a href="{{route('lmasuk.har.fwpump')}}" class="btn btn-sm btn-primary"><i class='bx bx-left-arrow-circle'></i> Back</a>
                </div>
            </div>
            <hr>
            <div class="mx-auto">
                <div class="m-auto rounded">
                    <form action="{{route('har.fwpump_updated', $data_id->id)}}" method="POST" class="mx-auto" id="edit-burner_system">
                            @csrf
                            @method('put')
