    ...
    <div class="content-wrapper mt-2">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="d-flex justify-content-between">
                <div>
                    <a href="{{route('lmasuk.har.hppump')}}" class="btn btn-sm btn-primary"><i class='bx bx-left-arrow-circle'></i> Back</a>
                </div>
            </div>
            <hr>
            <div class="mx-auto">
                <div class="m-auto rounded">
                    <form action="{{route('har.hppump_updated', $data_id->id)}}" method="POST" class="mx-auto" id="edit-burner_system">
                            @csrf
                            @method('put')
                            ...
                            <div class="p-3 card bg-secondary text-white">
                                ...
                                <div class="row">
                                    <div class="col-lg">
                                        ...
                                        <ul>
                                            <li>
                                                <small>A: {{$data_id->arus_HP_A}} A / {{$data_id->press_HP_A}} MPA / {{$data_id->status_HP_A}}</small>
                                            </li>
                                            <li>
                                                <small>B: {{$data_id->arus_HP_B}} A / {{$data_id->press_HP_B}} MPA / {{$data_id->status_HP_B}}</small>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-lg text-success">
                                        <small>
                                            HP Pump : {!!$data_id->info_HP!!}
                                        </small>
                                    </div>
                                </div>
                                <br>
