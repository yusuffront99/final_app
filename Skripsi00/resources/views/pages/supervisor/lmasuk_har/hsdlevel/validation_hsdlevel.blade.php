        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="mx-auto">
                <div class="m-auto rounded">
                    <form action="{{route('har.hsdlevel_updated', $data_id->id)}}" method="POST" class="mx-auto" id="edit-burner_system">
                            @csrf
                            @method('put')
                            ...
                            <div class="p-3 card bg-secondary text-white">
                                <h5 class="text-primary fw-bold">Validation High Speed Diesel</h5>
                                <br>
                                <div class="d-flex justify-content-between">
                                    <div class="">
                                        <small></small>
