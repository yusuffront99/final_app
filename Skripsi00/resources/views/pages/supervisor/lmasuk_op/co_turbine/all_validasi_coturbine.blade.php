                ...
                <div class="row">
                    <div class="col-lg-8 col-sm-9">
                        <div class="p-2">
                            ...
                            /
                            <a href="{{route('lmasuk.op.coturbine')}}" class="text-primary">
                ...
                <div class="card shadow-sm p-3 bg-light">
                    <table id="example" class="table table-striped my-3" style="width:100%">
                        <div class="d-flex justify-content-between mb-3">
                            <div>
                                <a href="{{route('lmasuk.op.coturbine')}}" class="btn btn-sm btn-dark"><i class='bx bx-left-arrow-circle'></i> Back</a>
                            </div>
                        </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($data as $dt)
                                <tr>
                                    <td>{{$no++;}}</td>
                                    <td>
                                        <a href="{{route('op.coturbine_validation', $dt->id)}}" class="bg-danger p-2 text-white"><i class='bx bx-edit'></i></a>
                                    </td>
                                    <td>{{$dt->users->nip}}</td>
