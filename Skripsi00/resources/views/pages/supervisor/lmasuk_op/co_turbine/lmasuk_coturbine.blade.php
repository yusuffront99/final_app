                            ...
                            <div class="row py-3 rounded m-auto">
                                <div class="col-lg-12 col-md-12">
                                    <div class="card bg-secondary text-white p-3">
                                                    ...
                                                    <tr>
                                                        <td class="text-center">
                                                            @if ($dt->status_equipments->status_name == 'Waiting')
                                                                <a href="{{route('op.coturbine_validation', $dt->id)}}" class="text-primary"><i class="bx bx-edit fs-3"></i></a>
                                        ...
                                        <a href="{{route('op.all_coturbine_validation')}}" class="btn btn-primary text-white btn-sm rounded-pill btn-view mt-3">see all <i class='bx bxs-right-arrow-circle'></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
