...
<div class="container">
    ...
    <div class="text-title">
        ...
        LAPORAN PERALATAN MINGGUAN - EMERGENCY DIESEL GENERATOR YSTEM 
        <br>{{Carbon\carbon::createFromFormat('Y-m-d', $rp->tanggal_update)->isoFormat('D MMMM Y')}}
        @endforeach
    </div>
    <br>
